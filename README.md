...
1. Open the `VaaniSetu2` project in Android Studio.
...
└── VaaniSetu2/             # Android Studio project (Kotlin)
```
...
No license specified yet — add one before making this public-facing beyond the hackathon submission.
